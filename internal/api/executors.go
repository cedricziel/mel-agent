...
type NodeExecutor interface {
	Execute(agentID string, node api.Node, input interface{}) (interface{}, error)
}

// DefaultExecutor performs no-op: returns input unchanged.
type DefaultExecutor struct{}

func (DefaultExecutor) Execute(agentID string, node api.Node, input interface{}) (interface{}, error) {
	return input, nil
}
...
func (IfExecutor) Execute(agentID string, node api.Node, input interface{}) (interface{}, error) {
...
func (HTTPRequestExecutor) Execute(agentID string, node api.Node, input interface{}) (interface{}, error) {
...
func (TimerExecutor) Execute(agentID string, node api.Node, input interface{}) (interface{}, error) {
...
func (ScheduleExecutor) Execute(agentID string, node api.Node, input interface{}) (interface{}, error) {
