...
export default function OpenAIModelNode({
  data,
  onAddClick,
  onDelete,
  id,
  ...
  return (
    <div
      className={`relative bg-blue-50 border-blue-200 rounded-full p-3 w-[120px] h-[120px] flex flex-col items-center justify-center cursor-pointer ${
    ...
    >
      ...
      <div className="font-semibold text-xs text-blue-700 text-center mt-3">
        OpenAI
      </div>
