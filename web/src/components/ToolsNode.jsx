...
export default function ToolsNode({ data, onAddClick }) {
  ...
  return (
    <div
      className={`relative bg-green-50 border-green-200 rounded p-2 pl-6 min-w-[100px] ${
    ...
    >
      ...
      {onAddClick && (
        <button
          ...
          className="absolute top-1 right-1 w-5 h-5 bg-green-600 text-white text-xs rounded flex items-center justify-center"
        >
          +
        </button>
      )}
      ...
      <div className="font-semibold text-sm text-green-700">{data.label}</div>
