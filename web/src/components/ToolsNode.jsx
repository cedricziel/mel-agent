...
export default function ToolsNode({ data, onAddClick, onDelete, id }) {
  ...
  return (
    <div
      className={`relative bg-green-50 border-green-200 rounded-full p-3 w-[120px] h-[120px] flex flex-col items-center justify-center ${
