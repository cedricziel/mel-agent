...
export default function AnthropicModelNode({
  data,
  onAddClick,
  onDelete,
  id,
  ...
  return (
    <div
      className={`relative bg-orange-50 border-orange-200 rounded-full p-3 w-[120px] h-[120px] flex flex-col items-center justify-center cursor-pointer ${
